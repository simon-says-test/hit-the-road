...
- Hitting a canyon wall costs a one-time speed cut the instant contact begins, on top of the continuous scraping drag while still in contact — trading some of the old flat impact damage for a slowdown that actually reads as hitting something solid, not just a number ticking down.
